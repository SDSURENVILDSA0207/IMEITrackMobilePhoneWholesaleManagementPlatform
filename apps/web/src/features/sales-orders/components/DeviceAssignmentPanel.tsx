              ...
              <table className="min-w-full text-left text-sm">
                <thead className="bg-slate-50 text-xs font-semibold uppercase tracking-wide text-slate-500">
                  <tr>
                    ...
                    <th className="min-w-[7rem] px-3 py-2">Sale price</th>
                  </tr>
                </thead>
                  ...
                  {filtered.length === 0 ? (
                    ...
                    filtered.map((d) => (
                      <tr key={d.id} className="bg-white hover:bg-slate-50/80">
                        ...
                        <td className="px-3 py-2 font-mono text-xs text-slate-900">{d.imei}</td>
                        ...
                        <td className="px-3 py-2 text-slate-600">{formatMoney(d.selling_price)}</td>
                        <td className="px-3 py-2">
                          <input
                            type="text"
                            inputMode="decimal"
